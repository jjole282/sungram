...
from sungram.users import models as user_models
from sungram.users import serializers as user_serializers
from sungram.notifications import views as notification_views
...
class ImageDetail(APIView):
    ...
    def put(self, request, image_id, format=None):
        ...
        if serializer.is_valid():
            ...
            return Response(data=serializer.data, status=status.HTTP_404_BAD_REQUEST)
